...
type DashboardPartybookingsDetailPageProps = DefaultPageProps & {
  pageName?: string;
  className?: string;
};
function DashboardPartybookingsDetailPage(
  props: DashboardPartybookingsDetailPageProps
): JSX.Element {
  return (
...
export default DashboardPartybookingsDetailPage;
