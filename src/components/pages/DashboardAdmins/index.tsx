...
type DashboardAdminsPageProps = DefaultPageProps & {
  pageName?: string;
  className?: string;
};
function DashboardAdminsPage(props: DashboardAdminsPageProps): JSX.Element {
  const adminService = useAdminService();
  const getApiAdminsInstance = adminService.useGetApiAdmins();
  const getApiAdminsResult = getApiAdminsInstance.useQuery();
                ...
                <Box className={styles.dashboard_content_filter_table}>
                  <Box className={styles.box_8}>
                    <Table
                      ...
                      data={get(getApiAdminsResult, "data.admins")}
                      footerColumnStyle={{
                        backgroundColor: "#fff",
                        borderColor: "#000",
                        borderStyle: "solid",
