...
try {
const responsePostApiPartybookings = await partybookingService.postApiPartybookings.fetch({"partybookings":{"user_id":get(authenticatedDataValue, 'id'),"party_id":undefined}})
